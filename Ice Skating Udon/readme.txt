...
EXTENDABILITY:
- If you want to add motion effects like wind sound or particles, you can read Speed and Direction data by calling _GetSpeed() and _GetDirection() on the Interface script on the parent object
